...
<div class="container">
    ...
    $sql1="SELECT * FROM image where id_image=$id_image";
                     ...
                     <div class="form-group form-control">
                       <div class="input-icon">
                         ...
                         echo " <option value=A>Section A</option>
                           <option selected value=B>Section B</option>
                           <option value=C>Section C</option>";
                          }
                            elseif ($section=='C') {
                            echo "  <option value=A>Section A</option>
                           <option value=B>Section B</option>
                           <option selected value=C>Section C</option>";
                            }
                          else
                          {
                 ...
                 <div id="destinataires"> 
                  <div class="row">
                     ...
                     <div class="form-group">
                         ...
                         <input type="file" name="image" value="hahahah" class="form-control-file form-control" required>
                     </div>
                     </div>
                  </div>
       <!----------------------------- numero de question ------------------------->
...
$rep4=$res3["reponse4"];
     ...
     <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-control">
                      <input type="text" class="form-control  "  placeholder="reponse" value="<?php echo $rep3 ?>" name="reponse3[]" > 
                    </div>
                  </div>
