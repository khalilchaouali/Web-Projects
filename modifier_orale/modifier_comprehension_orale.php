...
<div class="container">
 ...
 $sql2="SELECT * FROM question_orale where id_question=$id_question";
...
?>
 ...
 <div class="row">
     ...
     <!---------------------------------- les réponses ---------------------------------->
      <?php
       $sql3="select * from  reponse_orale, question_orale where reponse_orale.id_reponse=$id_reponse and question_orale.id_reponse=reponse_orale.id_reponse";
