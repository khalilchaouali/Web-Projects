...
$sql1 = "INSERT INTO test (nom_test, duree_orale, duree_ecrite, duree_lexique, duree_expression) VALUES('$nom','$tco','$tce','$tl','$tec')";
             ...
             <div class='col-12 col-lg-7 offset-lg-4 wow fadeInUpBig' data-wow-duration='2s'>
                  ...
                  <h1 class='fables-main-text-color bold-font mb-2 font-40'>Tests d'évaluation de niveau : 
                    ...
                    echo($_POST['nom']);}
                      ...
                      $conx=new PDO('mysql:host=localhost;dbname=junior1','root','');
                      $sql2="select nom_test from test where id=$id";
                                   ...
                                   echo("
                                    <div class='row'>
                                        <div class='col-12 col-sm-6 pb-lg-5 mt-4 mt-lg-0 wow fadeInDown' data-wow-delay='.4s'> 
                                         ...
                                         <a href='liste_comprehension_ecrite.php?id=$id'>afficher</a> <a href='comprehension_ecrite.php?id=$id'>inserer</a>
                                            </div>
                                            </div> 
                                        </div>
                                        <div class='col-12 col-sm-6 pb-lg-5 mt-4 mt-lg-0 wow fadeInDown' data-wow-delay='.8s'> 
                                            <div class='row text-center text-md-left'>
                                                ...
                                                <div class='col-12 col-md-9 pl-md-0'>
                                                 ...
                                                 <div class='btn-arrow-hvr-white1'>
                                         <a href='liste_lexique_structure.php?id=$id'>afficher</a> 
                                         <a href='lexique_structure.php?id=$id'>inserer</a>
                                            </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div class='row text-center text-md-left'>
                                                ...
                                                <div class='col-12 col-md-9 pl-md-0'>
                                                   <h2 class='text-white font-19 semi-font mb-2'>Compréhension orale</h2>
                                                    ...
                                                    <div class='btn-arrow-hvr-white1'>
                                         <a href='liste_comprehension_orale.php?id=$id'>afficher</a> 
                                         <a href='comprehension_orale.php?id=$id'>inserer</a>
                                                </div>
                                            </div> 
                                        </div>
                                        <div class='col-12 col-sm-6 pb-lg-5 mt-4 mt-lg-0 wow fadeInDown' data-wow-delay='1.6s'> 
                                            <div class='row text-center text-md-left'>
                                                ...
                                                <div class='col-12 col-md-9 pl-md-0'>
                                                 ...
                                                 <div class='btn-arrow-hvr-white1'>
                                         <a href='liste_expression_ecrite.php?id=$id'>afficher</a> 
                                         <a href='Expression_ecrite.php?id=$id'>inserer</a>
                                                </div>
