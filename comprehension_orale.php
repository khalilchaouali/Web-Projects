...
<div class="fables-header fables-after-overlay">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Ajout : <a href="liste_comprehension_orale.php">Compréhension orale</a></h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Compréhension orale</li>
          </ol>
        </nav> 
    </div>
</div>
...
<div class="container">
     <div class="row my-4 my-lg-5">
          <div class="col-12 col-md-8 offset-md-6 col-lg-8 offset-lg-2 text-center">
               ...
               <p class="font-20 semi-font fables-main-text-color mt-4 mb-4 mb-lg-5">Compréhension Orale</p>
               <form method="POST" action="insert_comprehension_orale.php" enctype="multipart/form-data">
                <?php
                echo("<input type='hidden' value = '$id' name = 'id_test' />");
                ?>
                <div class="row">
                ...
                <div class="row">
                      <div class="col-md-3 fieldel-responsi-labve">
                        <label for="image" >sélectionner une enregistrement</label>
                      </div>
                      <div class="col-md-6">
                     <div class="form-group">
                          <div class="row">
                         <input type="file" name="audio"  class="form-control-file form-control" >
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                     <button type="button" class="btn btn-success" id="aa">ajouter autre image</button>
                   </div>
                  </div></div>
                ...
                <div class="row">
                 ...
                 <div class="col-md-1">
                  ...
                  <input type="checkbox" name="rep_vrai[]" value="0">
                </div></div></div></div>
                ...
                <div class="row">
                 ...
                 <div class="col-md-1">
                    <div class="input-group mb-3">
                    <div class="input-group-prepend"><div class="input-group-text">
                  <input type="checkbox" name="rep_vrai[]" value="1">
                </div></div></div></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                    <div class="input-group-prepend"><div class="input-group-text">
                  <input type="checkbox" name="rep_vrai[]" value="2">
                </div></div></div></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    <div class="input-group mb-3">
                    <div class="input-group-prepend"><div class="input-group-text">
                  <input type="checkbox" name="rep_vrai[]" value="3">
                </div></div></div></div>
                </div>
              </div>
    ...
    var nb_question=1;
     $(document).ready(function(){
       $('#adduser').click(function(){
           nb_question++;
            var e1=$("<div class='row'><div class='col-md-3'><label for='reponse1'>numéro de question</label></div><div class='col-md-6'><div class='form-group form-control'><div class='input-icon'><input type='number' class='form-control'  placeholder='numéro de question' name='num_question[]' required> </div></div></div></div><div class='row'><div class='col-md-3 field-label-responsive'><label for='question' ><strong>Question"+nb_question+"</strong></label></div><div class='col-md-8'><div class='form-group form-control'><div class='input-icon'><input type='text' class='form-control  ' required placeholder='Question' name='question[]' id='question'></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 1</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control  '  placeholder='reponse' name='reponse1[]' required></div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='0'></div></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 2</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control  '  placeholder='reponse' name='reponse2[]' required> </div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='1'></div></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 3</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control'  placeholder='reponse' name='reponse3[]' ></div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='2'></div></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 4</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control'  placeholder='reponse' name='reponse4[]' required></div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='3'></div></div></div></div></div></div>");
     ...
     $(document).ready(function(){
       $('#aa').click(function(){
        var e=$("<div class='row'><div class='col-md-3 fieldel-responsi-labve'><label for='image' >sélectionner une image</label></div><div class='col-md-6'><div class='form-group'><div class='row'><input type='file' name='image[]'  class='form-control-file form-control' ></div></div></div></div>");
          $("#img").append(e);
})
     })
   </script>
