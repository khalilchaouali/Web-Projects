...
<div class="fables-header fables-after-overlay">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Ajout : lexique/structure</h2>
    </div>
</div>  
<!-- /End Header -->
...
<div class="container">
     <div class="row my-4 my-lg-5">
          <div class="col-12 col-md-8 offset-md-6 col-lg-8 offset-lg-2 text-center">
               ...
               <p class="font-20 semi-font fables-main-text-color mt-4 mb-4 mb-lg-5">lexique/structure</p>
               <form method="POST" action="insert_lexique_structure.php" enctype="multipart/form-data">
                <?php
