                       ...
                       <nav class="navbar navbar-expand-md btco-hover-menu py-lg-2" >
                            ...
                            <div class="collapse navbar-collapse" id="fablesNavDropdown"> 
                                ...
                                <ul class="navbar-nav mx-auto fables-nav">   
                                    <li class="nav-link">
                                        <a class="nav-link " href="#Accueil" id="sub-nav1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Accueil 
                                        </a>
                                 ...
                                 <ul class="navbar-nav mx-auto fables-nav">   
                                        ...
                                        <a class="nav-link" href="#Type" style="scroll-behavior: smooth;">
                                            Les sections du test
                                        </a>
                                       
                                </ul>
                                <ul class="navbar-nav mx-auto fables-nav">   
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="#test" style="scroll-behavior: smooth;">
                                           Les tests 
                                        </a>
             ...
             <div class="col-12 col-lg-7 offset-lg-4 wow fadeInUpBig" data-wow-duration="2s">
                ...
                <p class="font-30 fables-second-text-color" style="color: #4A56A5">Vous êtes la Bienvenue!</p>  
                  <p class="fables-forth-text-color font-22 mb-3">
                      Ce site vous offre l'opportunité de découvrir votre vrai niveau en français!
                  </p>
              ...
              <div class="col-12 col-lg-2 p-0">
                   <div class="text-center fables-main-background-color fables-sqr-rotation fables-second-border-color fables-sqr-rotation-services">
                      <div class="text-rotate">
                           <h2 class="text-white font-25"><br><span class="white-color font-40 bold-font mt-2 d-block"> Les sections du test</span></h2>
...
<!-- End Service -->
<div class="container-fluid my-0 my-lg-5" id="test">
          <div class="row" >
              <div class="col-12 col-lg-2 p-0">
                   <div class="text-center fables-main-background-color fables-sqr-rotation fables-second-border-color fables-sqr-rotation-services">
                      <div class="text-rotate">
                           <h2 class="text-white font-25"><br><span class="white-color font-40 bold-font mt-2 d-block"> Les Tests</span></h2>
                           ...
                           <div class="row">
                               <div class="col-12 col-lg-5 offset-lg-2">  
                                    <div class="row">
                                        ...
                                        <div class="btn-arrow-hvr-white">
                                         <a href="etudiant_ecrite.php?id_test=<?php echo $id; ?>">commencer <?php echo $nom ; ?></a>
                                            </div>
                                          <?php } ?>
                                    </div> 
                               </div>
              ...
              <div class="col-12 col-lg-10 p-0">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 offset-lg-2">
                      ...
                      L’élaboration d’un test qui permet l’évaluation des compétences en français et communication des apprenants de l’ENET’Com en amont et en aval de leur parcours de formation.
                        Cet outil pédagogique permet :<br>
                        - l’évaluation d’un grand nombre d’étudiants,<br>
                        - la réduction des délais de correction des épreuves,<br>
                        - la diminution des cas de fraude lors de l’évaluation.<br>
                      </p>
								   ...
								   <div>
                                      <img src="assets/custom/images/2.png" alt="Fables Template" class="fables-testimonial-carousel-img rounded-circle">   
                                        ...
                                        <p class="mb-3 fables-third-text-color fables-testimonial-detail font-15 font-italic position-relative mb-4 px-0 px-md-5">
                                            ...
                                            <br>
                                            Email: adnen.ellouze@enetcom.usf.tn<br>
                                            Tel : +216 23 32 42 50 <br>
                                            LinkedIn : <a href="https://www.linkedin.com/in/adnene-ellouz-28413580/">https://www.linkedin.com/in/adnene-ellouz-28413580/</a><br>
                                            Facebook: <a href="https://www.facebook.com/adnene.ellouz">https://www.facebook.com/adnene.ellouz </a><br>

                                            Groupe Facebook: <a href="https://www.facebook.com/adnene.ellouz">ENETCOM.FR </a> <br>
                                            Adresse: ENET’Com, route de Tunis Km 11, Technopole Cité Elons, Sfax- Tunisie <br>
                                            Site internet: <a href="www.enetcom.rnu.tn">www.enetcom.rnu.tn</a><br>
                                        </p>
                                        <h3 class="font-14 semi-font text-white"></h3>
                                        <h3 class="font-13 font-italic white-color mt-2"></h3>
