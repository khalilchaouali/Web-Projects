...
<div class="container">
     <div class="row my-4 my-lg-5">
          <div class="col-12 col-md-8 offset-md-6 col-lg-8 offset-lg-2 text-center">
               ...
               <form method="POST" action="modif_question.php" enctype="multipart/form-data">

       <!----------------------------- numero de question ------------------------->
                 <?php
    $conx=new PDO("mysql:host=localhost;dbname=junior1","root","");
    
 $sql2="SELECT * FROM question where id_question=$id_question";
 ...
 <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-control">
                      ...
                      <input type="number" class="form-control  "  placeholder="numéro de question" name="num_question" value="<?php echo $num_question ?>" required> 
                    </div>
                    </div>
                  </div>
     ...
     <div class="row">
                      ...
                      <label for="question" ><strong>Question <?php echo $num_question ?></strong></label> 
                       </div>
                       <div class="col-md-8">
                       <div class="form-group form-control"> 
...
$rep_vrai=$res3["reponse_vrai"];
     ...
     <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-control">
                      <input type="text" class="form-control" value="<?php echo $rep1 ?>"  placeholder="reponse" name="reponse1" required> 
                    </div>
                  </div>
                  ...
                  <input type="radio" name="rep_vrai" value="rep1" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-control">
                      <input type="text" class="form-control  " value="<?php echo $rep2 ?>" placeholder="reponse" name="reponse2" required > 
                    </div>
                  </div>
                  ...
                  <div class="col-md-1">
                    <div class="input-group mb-3">
                    <div class="input-group-prepend"><div class="input-group-text">
                  <input type="radio" name="rep_vrai" value="rep2" required="">
                </div></div></div></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-control">
                      <input type="text" class="form-control checked "  placeholder="reponse" value="<?php echo $rep3 ?>" name="reponse3" > 
                    </div>
                  </div>
                  ...
                  <div class="col-md-1">
                    <div class="input-group mb-3">
                    <div class="input-group-prepend"><div class="input-group-text">
                  <input type="radio" name="rep_vrai" value="rep3" required="">
                </div></div></div></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-control">
                      <input type="text" class="form-control  "  placeholder="reponse" value="<?php echo $rep4 ?>" name="reponse4" required> 
                    </div>
                  </div>
                  <div class="col-md-1">
                    <div class="input-group mb-3">
                    <div class="input-group-prepend"><div class="input-group-text">
                  <input type="radio" name="rep_vrai" value="rep4" required>
                </div></div></div></div></div>
              </div>
             <input type="hidden" name="idReponse" value="<?php echo $id_reponse?>">
<?php 
...
?>
                 ...
                 <button type="submit" class="btn btn-success btn-block rounded-0 white-color fables-main-hover-background-color fables-second-background-color font-16 semi-font py-3 form-control" name="enregistrer">enregistrer</button>
                  <input type="hidden" name="aaa" value="<?php echo $id_question ?>">
                </form>
          </div>
     </div>
    ...
    var nb_question=1;
     $(document).ready(function(){
       $('#adduser').click(function(){
        ...
        var e1=$("<div class='row'><div class='col-md-3'><label for='reponse1'>numéro de question</label></div><div class='col-md-6'><div class='form-group form-control'><div class='input-icon'><input type='number' class='form-control'  placeholder='numéro de question' name='num_question[]' required> </div></div></div></div><div class='row'><div class='col-md-3 field-label-responsive'><label for='question' ><strong>Question"+nb_question+"</strong></label></div><div class='col-md-8'><div class='form-group form-control'><div class='input-icon'><input type='text' class='form-control  ' required placeholder='Question' name='question[]' id='question'></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 1</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control  '  placeholder='reponse' name='reponse1[]' required></div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='rep1'></div></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 2</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control  '  placeholder='reponse' name='reponse2[]' required> </div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='rep2'></div></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 3</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control'  placeholder='reponse' name='reponse3[]' ></div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='rep3'></div></div></div></div></div><div class='row'><div class='col-md-3'><label for='reponse1'>reponse 4</label></div><div class='col-md-6'><div class='form-group form-control'><input type='text' class='form-control'  placeholder='reponse' name='reponse4[]' required></div></div><div class='col-md-1'><div class='input-group mb-3'><div class='input-group-prepend'><div class='input-group-text'><input type='checkbox' name='rep_vrai[]' value='rep4'></div></div></div></div></div></div>");
