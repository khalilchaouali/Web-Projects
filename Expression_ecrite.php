...
<div class="container">
     <div class="row my-4 my-lg-5">
          <div class="col-12 col-md-8 offset-md-6 col-lg-8 offset-lg-2 text-center">
               ...
               <form method="POST" action="insert_Expression_écrite.php" enctype="multipart/form-data">
                <?php
    ...
    var nb_question=1;
     $(document).ready(function(){
       $('#adduser').click(function(){
           nb_question++;
            var e1=$("<div class='row'><div class='col-md-3 field-label-responsive'><label for='question' ><strong>Question"+nb_question+"</strong></label></div><div class='col-md-8'><div class='form-group form-control'><div class='input-icon'><input type='text' class='form-control  ' required placeholder='Question' name='question[]' id='question'></div></div></div></div>");
